    ...
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          ...
          <li class="logo"><i class="iconfont el-icon-notebook-2"></i><span>试题中心</span></li>
          <li><a @click="exam()">试卷库</a></li>
          <li><a @click="practice()">我的练习</a></li>
          <li><router-link to="/scoreTable">我的分数</router-link></li>


          <li class="right" @mouseenter="flag = !flag" @mouseleave="flag = !flag">
            <a><i class="iconfont icon-Userselect icon"></i>{{ user.userName }}</a>
